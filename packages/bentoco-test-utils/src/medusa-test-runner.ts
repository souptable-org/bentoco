...
import { Migrator } from "@bentoco/framework/migrations"
import { MedusaAppOutput } from "@bentoco/framework/modules-sdk"
...
class MedusaTestRunner {
  ...
  private async setupApplication(): Promise<void> {
    const { container, MedusaAppLoader } = await import("@bentoco/framework")
