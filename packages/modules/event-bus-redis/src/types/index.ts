...
// import type { EventBusEventsOptions } from "@bentoco/types"

// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import type { ModuleOptions } from "@bentoco/types"
...
declare module "@bentoco/types" {
  interface ModuleOptions {
    "@bentoco/event-bus-redis": EventBusRedisModuleOptions
    "@bentoco/medusa/event-bus-redis": EventBusRedisModuleOptions
  }
}
