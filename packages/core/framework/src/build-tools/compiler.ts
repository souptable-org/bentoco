import type { AdminOptions, ConfigModule, Logger } from "@bentoco/types"
import { FileSystem, getConfigFile, getResolvedPlugins } from "@bentoco/utils"
...
export class Compiler {
   ...
   * using the "@bentoco/admin-bundler" package.
   */
