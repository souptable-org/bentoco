import type { AdditionalData } from "@bentoco/framework/types"
import { isDefined, PromotionActions } from "@bentoco/framework/utils"
import {
  createHook,
  createWorkflow,
  transform,
 ...
 *
 * ```ts
 * import { refreshCartItemsWorkflow } from "@bentoco/medusa/core-flows";
