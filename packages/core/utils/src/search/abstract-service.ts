import { SearchTypes } from "@bentoco/types"
 ...
 *  from the `@bentoco/utils` package.
 *
 ...
 * import { AbstractSearchService } from "@bentoco/utils"
 *
  ...
  implements SearchTypes.ISearchService
{
   ...
   * @example
   * // ...
   * import { ProductService } from "@bentoco/medusa"
   *
