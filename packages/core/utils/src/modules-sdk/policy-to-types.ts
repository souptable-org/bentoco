 ...
 * - "policy-bindings.d.ts" - Module augmentation for @bentoco/framework/utils
 *
...
// Module augmentation for @bentoco/framework/utils
// Types and globals are defined in policy-types.d.ts
declare module "@bentoco/framework/utils" {
