import { Filter as MikroORMFilter } from "@bentoco/deps/mikro-orm/core"
import { TSMigrationGenerator } from "@bentoco/deps/mikro-orm/migrations"
import { ModuleServiceInitializeOptions } from "@bentoco/types"
...
export async function mikroOrmCreateConnection(
  ...
  const { MikroORM, defineConfig } = await import(
    "@bentoco/deps/mikro-orm/postgresql"
  )
