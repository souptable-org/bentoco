...
export class Migration20250617080328 extends Migration {
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(`alter table if exists "loyalty_gift_card" add column if not exists "customer_id" text null;`);
  }
