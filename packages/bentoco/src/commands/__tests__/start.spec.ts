import * as utils from "@bentoco/framework/utils"
...
jest.mock("@bentoco/framework/config", () => {
  return {
    configManager: {
      config: {},
    },
...
describe("start", () => {
  beforeEach(() => {
    jest.clearAllMocks()
    jest.doMock("@bentoco/framework/utils", () => ({
      ...jest.requireActual("@bentoco/framework/utils"),
