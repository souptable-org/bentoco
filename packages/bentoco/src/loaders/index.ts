import { container, MedusaAppLoader, policiesLoader } from "@bentoco/framework"
import { asValue } from "@bentoco/framework/awilix"
import { configLoader } from "@bentoco/framework/config"
import { pgConnectionLoader } from "@bentoco/framework/database"
import { featureFlagsLoader } from "@bentoco/framework/feature-flags"
import { expressLoader } from "@bentoco/framework/http"
import { JobLoader } from "@bentoco/framework/jobs"
import { LinkLoader } from "@bentoco/framework/links"
import { logger as defaultLogger } from "@bentoco/framework/logger"
import { SubscriberLoader } from "@bentoco/framework/subscribers"
import {
  ConfigModule,
  LoadedModule,
  MedusaContainer,
...
import { WorkflowLoader } from "@bentoco/framework/workflows"
...
export default async ({
  ...
  const { createDefaultsWorkflow } = await import("@bentoco/core-flows")
