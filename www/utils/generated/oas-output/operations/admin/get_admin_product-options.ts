 ...
 *         - type: string
 *           title: title
 *           description: Filter by a product option title.
 *         - type: array
 *           description: Filter by product option titles.
 *           items:
 *             type: string
 *             title: title
 ...
 *   - name: created_at
 *     in: query
 *     description: Filter by the product option's creation date.
 *     required: false
 *     schema:
 *       type: object
 *       description: Filter by the product option's creation date.
 ...
 *   - name: q
 *     in: query
 *     description: Search query for product options.
 *     required: false
 *     schema:
 *       type: string
 *       title: q
 ...
 *     label: cURL
 *     source: |-
 *       curl '{backend_url}/admin/product-options' \
