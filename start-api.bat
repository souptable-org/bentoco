...
echo starting API > C:\Users\harsh\bentoco\server-9000.log
node packages\cli\bentoco-cli\cli.js start --types false -p 9000 >> C:\Users\harsh\bentoco\server-9000.log 2>&1
